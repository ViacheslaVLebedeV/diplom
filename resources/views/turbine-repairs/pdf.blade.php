...
<head>
    <meta charset="UTF-8">
    <title>Отчёт по ремонту турбокомпрессоров</title>
    <style>
        body {
...
<div class="grid grid-cols-6 gap-6">
    <div class="col-span-2">
        <div class="report-info">
            <p class="number"><span class="label">№ отчета по ремонту турбокомпрессоров:</span><span class="underline"><span>{{ $data['number'] }}</span></span></p>
